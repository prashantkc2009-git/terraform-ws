...
# Environment: prod
# File: main.tf
# Description: Tiers modules to build out the full infrastructure for Prod.
# ==============================================================================
...
module "eks" {
  ...
  spot_desired_size        = var.eks_spot_desired_size
  spot_min_size            = var.eks_spot_min_size
  spot_max_size            = var.eks_spot_max_size
}

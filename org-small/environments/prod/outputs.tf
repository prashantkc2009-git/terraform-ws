...
# Environment: prod
# File: outputs.tf
# Description: Root level outputs for Prod environment.
# ==============================================================================
...
output "ec2_legacy_standby_instance_id" {
  value       = module.ec2_legacy.standby_instance_id
  description = "The instance ID of the standby EC2 legacy monolith."
}

output "ec2_legacy_standby_private_ip" {
  value       = module.ec2_legacy.standby_instance_private_ip
  description = "The private IP address of the standby EC2 legacy monolith."
}

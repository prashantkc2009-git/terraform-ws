...
# Environment: staging
# File: variables.tf
# Description: Defines configuration parameters overrideable for the staging
#              environment.
# ==============================================================================
...
variable "domain_name" {
  ...
  default     = "staging.company-small.io"
}
...
# ------------------------------------------------------------------------------
# COMPUTE LAYER CONFIGURATION (STAGING OVERRIDES)
# ------------------------------------------------------------------------------

...
# File: main.tf
# Description: Configures Thanos telemetry S3 stores and VPC Flow Logs.
# ==============================================================================

# 1. Thanos Metrics Long-term Storage S3 Bucket
...
# 2. Log Archive Bucket with S3 Object Lock (Compliance mode - 7 years / 2555 days)
...
# 3. CloudWatch Flow Logs for VPC

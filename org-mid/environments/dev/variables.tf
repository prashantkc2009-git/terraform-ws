...
# Environment: dev
# File: variables.tf
# Description: Defines input parameters for the Dev environment sandbox.
# ==============================================================================

...
# Environment: prod
# File: main.tf
# Description: Instantiates foundational org-mid modules for the Production environment.
# ==============================================================================
...
module "networking" {
  ...
  tgw_id                = ""    # TODO: Replace with actual Transit Gateway ID for central egress
